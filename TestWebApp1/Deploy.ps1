# Settings
#---------------
$appPoolName = ("Jeremy-Pool-" + $OctopusEnvironmentName)
$siteName = ("Jeremy - " + $OctopusEnvironmentName) 
...
if (!$site) { 
	...
	Write-Host "id->" $id
	Write-Host "siteBindings->" $siteBindings
	Write-Host "siteBindings->" $webRoot
